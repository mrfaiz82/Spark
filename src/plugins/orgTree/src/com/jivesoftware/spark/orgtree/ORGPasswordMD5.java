...
public class ORGPasswordMD5 {
	...
	private static ORGPasswordMD5 instance;
	private ORGPasswordMD5(){}	
	
	public static ORGPasswordMD5 getInstance()
	{
		if (instance == null)
		{
			instance = new ORGPasswordMD5();
		}
		return instance;
	}
